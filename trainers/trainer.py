...
def train_parser():
    ...
    parser.add_argument("--model", choices=[ 'MAGNET'], default='MAGNET')
    parser.add_argument("--dataset", choices=['cub_raw','stanford_dog', 'stanford_car',
                                              'CUB_fewshot_cropped'],default='cub_raw')
    parser.add_argument("--resume", action="store_true")
    parser.add_argument("--resume_epoch", type=int, default=0)

    parser.add_argument("--disturb_num", help="disturb_num", type=int, default=3)
    parser.add_argument("--weight", help="weight", type=float, default=0)
