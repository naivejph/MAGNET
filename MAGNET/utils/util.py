...
from MAGNET.models.MAGNET import MAGNET
...
def dataset_path(args):
    ...
    if args.dataset == 'cub_raw':
        fewshot_path = os.path.join(data_path, 'CUB_fewshot_raw')
    elif args.dataset == 'CUB_fewshot_cropped':
...
def get_save_path(args):
    ...
    if args.dataset == 'cub_raw':
        ...
        path = os.path.join(path, 'dogs')
    elif args.dataset == 'stanford_car':
        path = os.path.join(path, 'cars_196')
